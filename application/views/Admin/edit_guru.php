            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <form action="<?php echo base_url();?>Admin/Home/proses_update_guru/<?php echo $k['id_guru']?>" method="post" role="form">
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="nama">Nama</label>
                                            <input type="text" name="nama" class="form-control" value="<?php echo $k['nama']?>" disabled>
                                        </div>
                                    </div>
